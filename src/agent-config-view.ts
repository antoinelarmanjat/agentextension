...
export class AgentConfigViewProvider implements vscode.WebviewViewProvider {
  public static readonly viewId = 'agentConfigurator.config';
  ...
  // Allow extension to send events to the resolved webview
  ...
  resolveWebviewView(
    ...
    // mark unused parameters as used for linting without affecting runtime
      ...
      async (message: WebviewToExtensionMessage) => {
        switch (message.type) {
          case 'ready': {
            ...
            this.postMessage({ type: 'init', data: init });
            break;
          }
          case 'save': {
